...
function saveStats(stats){
  ...
  let textFromStats = 'Dur: '+stats.duration.toLocaleString(undefined, { maximumFractionDigits: 1, minimumFractionDigits: 1 });
  for (let i = 0;i<stats.log.length;i++){
    textFromStats += ', ' + stats.log[i].one + ':'+stats.log[i].duration.toLocaleString(undefined, { maximumFractionDigits: 1, minimumFractionDigits: 1 });
  }
