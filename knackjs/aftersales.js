...
//Hover on service visit table for technician view of job card
let shownTooltipId = null;
function serviceVisitsTooltipsTechView(viewId = '3147', fieldId = '325'){
  //console.log('serviceVisitsTooltipsTechView');
  $('div[id*="tooltip"]').each(function(){
    $(this).attr("style","background: white; position: fixed; display:none;");
  });
  $('div[id="view_'+viewId+'"]').on("mouseleave", function (e) {
...
$(document).on('knack-scene-render.scene_1000', function(event, scene) {
 serviceVisitsTooltipsTechView();
});
