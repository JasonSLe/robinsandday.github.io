...
function saveStats(stats){
  ...
  let textFromStats = 'Dur: '+stats.duration.toLocaleString("en-GB", { maximumFractionDigits: 0, minimumFractionDigits: 1 });
  for (let i = 0;i<stats.log.length;i++){
    textFromStats += ', ' + stats.log[i].one + ':'+stats.log[i].duration.toLocaleString("en-GB", { maximumFractionDigits: 0, minimumFractionDigits: 1 });
  }
