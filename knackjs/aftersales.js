...
$(document).on('knack-form-submit.view_1530', function(event, view, data) {
  callPostHttpRequest("https://hook.integromat.com/3b7aqxlblay6r5egi5rev56ql8qiy4g2", {"Record ID":data.id,"Message Sent To Customer":data.field_2123},"Aftersales VR Update SMS Two Way")
});
