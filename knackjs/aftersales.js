...
var loginSceneNames = ["scene_20","scene_32","scene_38","scene_44","scene_52","scene_57","scene_111","scene_74","scene_224"]; ///add scene numbers as necessary
...
$(document).on('knack-form-submit.view_841 knack-form-submit.view_843 knack-form-submit.view_839', function(event, view, data) {
	console.log("Test2");
...
$(document).on('knack-form-submit.view_732', function(event, view, data) { 
  ...
  "Service GDPR SMS":data.field_1052_raw, "Sales GDPR PHONE":data.field_1054_raw, "Sales GDPR EMAIL":data.field_1055_raw,"Sales GDPR POST":data.field_1056_raw, "Sales GDPR SMS":data.field_1057_raw, "Customer Magic Number":data.field_1006_raw.replace(/\D/g, '')},"Submit form for GDPR preferences update in Check-in process")
});
