...
$(document).on('knack-form-submit.view_3424', function(event, view, data) { 
	...
	console.log(data);
  let dataToSend = JSON.stringify({"Knack ID":data.id,"Dare Vehicle Marked Ready For Collection2":data.field_6041_raw.date_formatted + " " + data.field_6041_raw.hours + ":" + data.field_6041_raw.minutes,
