...
//General function, For Hover over messages


  function getFieldForRowID(view, 
field, id){
    ...
    try {
      ...
      if 
(Knack.views[view] 
&& Knack.views[view].model){

        
let record = 
Knack.views[view].model.data.models.find(function(el){
...
(ex) { console.log('getFieldForRowID',ex)}

  }

  //Parts Power Supply - scene 370 - Stock Management Table

  $(document).on('knack-view-render.view_1149', function 
(event, 
view, data) {

    $('td[class="field_3155"]').each(function(){$(this).text($(this).text().trim().substr(0,6)+$(this).text().trim().substr(8,2));});

    //This part of code hides field_7215 from the list and then adds it as mouse over to field 380
