...
$(document).on('knack-form-submit.view_370', function(event, view, data) { 
  ...
  "Damage Photo 4":data.field_720_raw, "Damage Photo 5":data.field_719_raw, "Damage Photo 6":data.field_721_raw, "Side Profile Photo":data.field_5372_raw, "Date Of Last Service":data.field_535_raw, "Total Refurb Cost":data.field_624_raw,
...
$(document).on('knack-form-submit.view_396', function(event, view, data) { 
  ...
  "URL to Access Valuation":"https://www.robinsandday.co.uk/digital#new-appraisal/offsite-or-trade-valuation/" + data.id + "/","Valuation":data.field_753_raw,
  "Enquiry Max Dealer UID":data.field_5799_raw, "Enquiry Max Enquiry UID":data.field_5800_raw, "Offsite Image":data.field_4194_raw, "Valuation Pending On site Inspection":data.field_867_raw,
   "Manger Override Valuation Pending Onsite Valuation":data.field_866_raw, "Date Of Last Service":data.field_535_raw, "Total Refurb Cost":data.field_624_raw, "Mechanical Refub Cost":data.field_622_raw, 
   "Aesthetic Refub Cost":data.field_623_raw, "Vehicle Test Driven":data.field_745_raw, "Offer valid Up to":data.field_3203_raw, "Valuation Notes":data.field_4390_raw, "Sales Advisor Refurb Description":(data.field_882_raw, data.field_883_raw), 
