...
$(document).on('knack-form-submit.view_370', function(event, view, data) { 
  ...
  "Rear 3/4 Photo":data.field_5373_raw.url, "Interior Photo":data.field_5374_raw.url, "Dashboard Photo":data.field_5723_raw.url, "Damage Photo 1":data.field_716_raw.url, "Damage Photo 2":data.field_717_raw.url, "Damage Photo 3":data.field_718_raw.url, 
  "Damage Photo 4":data.field_720_raw.url, "Damage Photo 5":data.field_719_raw.url, "Damage Photo 6":data.field_721_raw.url, "Side Profile Photo":data.field_5372_raw.url, "Date Of Last Service":data.field_535_raw.date_formatted, "Total Refurb Cost": "£" + data.field_624_raw,
