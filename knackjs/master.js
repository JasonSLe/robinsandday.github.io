...
$(document).on('knack-form-submit.view_370', function(event, view, data) { 
  ...
  function stringUndefined(valueA){
       var result = 0;
      if(typeof valueA === "string" ){
          if(valueA.includes("undefined")){
              result = 1;
          } 
      }
      return result;
  ...
  let newJSON = JSON.stringify(dataToSend, function (key, value) {return (value === undefined || value === null || stringUndefine(value) === 1) ? "1" : value;});
