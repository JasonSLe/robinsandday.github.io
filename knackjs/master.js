...
$(document).on('knack-form-submit.view_370', function(event, view, data) { 
  ...
  "Damage Photo 4":data.field_720_raw, "Damage Photo 5":data.field_719_raw, "Damage Photo 6":handlUndefined(data.field_721_raw), "Side Profile Photo":data.field_5372_raw, "Date Of Last Service":data.field_535_raw.date_formatted, "Total Refurb Cost": "£" + data.field_624_raw,
