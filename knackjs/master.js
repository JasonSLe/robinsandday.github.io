...
function printE(text) {
  ...
  if (text.includes('time=')){
    ...
    document.getElementById("videoFileUploadProgress").textContent('Converting video, progress: '+Math.round(convertTimeToSeconds(dT)/videoDuration)+'%');
  }
}
