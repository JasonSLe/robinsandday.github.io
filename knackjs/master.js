...
$(document).on('knack-form-submit.view_3993', function(event, view, data) { 
  ...
  let dataToSend = JSON.stringify({"Knack Stock UID":data.id,"Reg":data.field_2694_raw,"Dealer4":Object.values(data.field_2721_raw[0])[0],"Source Of Payload" : "knack direct","ConnectedDealer":data.field_6476_raw}) ;
  var rData = $.ajax({
    url: commandURL,
    type: 'POST',
    contentType: 'application/json',
...
//  let dataToSend = JSON.stringify({"Knack ID":data.id,"Dare Vehicle Marked Ready For Collection":data.field_6041_raw,"Dealer ID":data.field_4943_raw,"Source Of Payload" : "knack direct"}) ;
//  var rData = $.ajax({
//    url: commandURL,
//    type: 'POST',
//    contentType: 'application/json',
