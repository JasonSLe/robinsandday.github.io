...
$(document).on('knack-form-submit.view_3424', function(event, view, data) { 
  ...
  let dataToSend = JSON.stringify({"Knack ID":data.id,"Dare Vehicle Marked Ready For Collection":data.field_6041_raw, "Dealer ID1":data.field_4943_raw, "Source Of Payload" : "knack direct"}) ;
  var rData = $.ajax({
    url: commandURL,
    type: 'POST',
    contentType: 'application/json',
