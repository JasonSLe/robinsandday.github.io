...
$(document).on('knack-form-submit.view_3926', function(event, view, data) { 
  ...
  let dataToSend = JSON.stringify({"Knack ID of Used Deal File":data.id,"Image URL1":data.field_4944_raw,"Image thumbnail URL":"data.field_****_raw","Dealer":data.field_4943_raw,"Source Of Payload" : "knack direct"}) ;
  var rData = $.ajax({
    url: commandURL,
    type: 'POST',
    contentType: 'application/json',
